...
namespace updater.software
{
    ...
    public class CMake : NoPreUpdateProcessSoftware
    {
        ...
        public override AvailableSoftware knownInfo()
        {
            ...
            return new AvailableSoftware("CMake",
                ...
                new InstallInfoMsi(
                    ...
                    "584080086102dfcc0cfdcc74596504c301f7b65c1f13208957dbec85e9800b3d",
                    signature,
                    "/qn /norestart"),
                new InstallInfoMsi(
                    "https://github.com/Kitware/CMake/releases/download/v" + version + "/cmake-" + version + "-windows-x86_64.msi",
                    HashAlgorithm.SHA256,
                    "97e249f199b86c1fc56dbc5e80b1a9e1f912c34dfbf8e7933ba1944e3034455f",
                    signature,
                    "/qn /norestart")
                    );
        }
        ...
        {
            return ["cmake", "cmake-gui", "cpack", "ctest"];
        }
