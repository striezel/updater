...
{
    /// <summary>
    /// Contains tests for OpenJRE21 class.
    /// </summary>
    [TestClass]
    public class OpenJRE21_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            _searchForNewer(new OpenJRE21(false));
        }
        ...
        {
            _upToDate_info(new OpenJRE21(false));
        }
