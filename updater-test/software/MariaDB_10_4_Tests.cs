...
{
    /// <summary>
    /// Contains tests for MariaDB_10_4.
    /// </summary>
    [TestClass]
    public class MariaDB_10_4_Tests: BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            var mdb = new MariaDB_10_4(false);
        ...
        {
            _searchForNewer(new MariaDB_10_4(false));
        }
        ...
        {
            _upToDate_info(new MariaDB_10_4(false));
        }
    }
}
