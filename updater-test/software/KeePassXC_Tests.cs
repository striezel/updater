...
{
    /// <summary>
    /// Contains tests for the KeePassXC class.
    /// </summary>
    [TestClass]
    public class KeePassXC_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            _searchForNewer(new KeePassXC(false));
        }
        ...
        {
            _upToDate_info(new KeePassXC(false));
        }
    } // class
} // namespace
