...
namespace updater_test.software
{
    ...
    public class Doxygen_Tests: BasicSoftwareTests
    {
        ...
        {
            var doxy = new Doxygen(false);
            Assert.IsTrue(doxy.implementsSearchForNewer());
        }
        ...
        {
            _searchForNewer(new Doxygen(false));
        }
        ...
        {
            _upToDate_info(new Doxygen(false));
        }
    } // class
} // namespace
