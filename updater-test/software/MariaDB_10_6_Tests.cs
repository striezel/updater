...
{
    /// <summary>
    /// Contains tests for MariaDB_10_6.
    /// </summary>
    [TestClass]
    public class MariaDB_10_6_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            var mdb = new MariaDB_10_6(false);
        ...
        {
            _searchForNewer(new MariaDB_10_6(false));
        }
        ...
        {
            _upToDate_info(new MariaDB_10_6(false));
        }
    }
}
