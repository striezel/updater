...
{
    /// <summary>
    /// Contains tests for the InstallInfoLibO class.
    /// </summary>
    [TestClass]
    public class InstallInfoLibO_Tests
    {
        [TestMethod]
        ...
        public void createInstallProcess_with_installation_directory()
        {
            ...
            Assert.IsNotNull(proc);
            Assert.AreEqual("msiexec.exe", proc.StartInfo.FileName);
            Assert.AreEqual("/i \"" + file_name + "\" INSTALLLOCATION=\"C:\\Program Files\\foo\" /qn /norestart", proc.StartInfo.Arguments);
        }
