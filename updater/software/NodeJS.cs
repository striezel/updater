...
namespace updater.software
{
    ...
    public class NodeJS : NoPreUpdateProcessSoftware
    {
        ...
        /// </summary>
        private static readonly DateTime certificateExpiration = new(2026, 5, 15, 22, 41, 19, DateTimeKind.Utc);
        ...
        public override AvailableSoftware knownInfo()
        {
            ...
            return new AvailableSoftware(
                ...
                new InstallInfoMsi(
                    ...
                    "de75961b3162771f8f071608226fabc5029174c279a49c2b88621a8091acffa3",
                    signature,
                    "/qn /norestart"),
                new InstallInfoMsi(
                    "https://nodejs.org/download/release/v" + version + "/node-v" + version + "-x64.msi",
                    HashAlgorithm.SHA256,
                    "4e41d4fea6661eb330fa88b1cdce2ba5e6b07d93f689c9d549cb9dd09cb9b2b0",
                    signature,
                    "/qn /norestart")
                    );
        }
