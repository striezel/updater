...
namespace updater.software
{
    ...
    public class NotepadPlusPlus : NoPreUpdateProcessSoftware
    {
        ...
        public override AvailableSoftware knownInfo()
        {
            ...
            const string version = "8.1.9.2";
            const string tag = "8.1.9.2";
            return new AvailableSoftware("Notepad++",
                ...
                new InstallInfoExe(
                    ...
                    "a762e97b4f3387da0d273d692da16d34fbb8fbfdc8c07b04c3c837ff33220f00",
                    signature,
                    "/S"),
                new InstallInfoExe(
                    "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v" + tag + "/npp." + version + ".Installer.x64.exe",
                    HashAlgorithm.SHA256,
                    "2bb2c7bca2b2ad54701c15cabcbc336643f3829d33d3411c0fb8f75ab1bfa1a0",
                    signature,
                    "/S")
                );
        }
