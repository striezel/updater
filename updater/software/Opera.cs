    ...
    public class Opera : Improved64BitDetectionSoftware
    {
        ...
        public override AvailableSoftware knownInfo()
        {
            ...
            return new AvailableSoftware("Opera",
                ...
                "^Opera Stable [0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+$",
                new InstallInfoExe(
                    "https://get.geo.opera.com/pub/opera/desktop/117.0.5408.154/win/Opera_117.0.5408.154_Setup.exe",
                    HashAlgorithm.SHA256,
                    "83ebe8b5c928310e5acca62e12183848ef43552cd8f52f802fc87595d5a2e8f5",
                    signature,
                    silentOptions),
                new InstallInfoExe(
                    "https://get.geo.opera.com/pub/opera/desktop/117.0.5408.154/win/Opera_117.0.5408.154_Setup_x64.exe",
                    HashAlgorithm.SHA256,
                    "c27d0521f98d935fc796963772e505e697962edfc717a85743c777a5121694f5",
                    signature,
                    silentOptions)
                    );
        }
