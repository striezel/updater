...
{
    /// <summary>
    /// Contains tests for MariaDB_11_8.
    /// </summary>
    [TestClass]
    public class MariaDB_11_8_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            var mdb = new MariaDB_11_8(false);
        ...
        {
            _searchForNewer(new MariaDB_11_8(false));
        }
        ...
        {
            _upToDate_info(new MariaDB_11_8(false));
        }
    }
}
