...
{
    /// <summary>
    /// Contains tests for the Pidgin class.
    /// </summary>
    [TestClass]
    public class Pidgin_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            _searchForNewer(new Pidgin(false));
        }
        ...
        {
            _upToDate_info(new Pidgin(false));
        }
    } // class
} // namespace
