    ...
    public class Opera : Improved64BitDetectionSoftware
    {
        ...
        public override AvailableSoftware knownInfo()
        {
            ...
            return new AvailableSoftware("Opera",
                ...
                "^Opera Stable [0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+$",
                new InstallInfoExe(
                    "https://get.geo.opera.com/pub/opera/desktop/126.0.5750.59/win/Opera_126.0.5750.59_Setup.exe",
                    HashAlgorithm.SHA256,
                    "8cb455093480846a2b5ee3842dc5eb33321cab48c9261ebd70c19c85a37418ad",
                    signature,
                    silentOptions),
                new InstallInfoExe(
                    "https://get.geo.opera.com/pub/opera/desktop/126.0.5750.59/win/Opera_126.0.5750.59_Setup_x64.exe",
                    HashAlgorithm.SHA256,
                    "a9255de7a5abcc297d3a718bcb00aff814ddffd337e54f655f2d9e179ceb16a1",
                    signature,
                    silentOptions)
                    );
        }
