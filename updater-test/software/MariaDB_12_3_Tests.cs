...
{
    /// <summary>
    /// Contains tests for MariaDB_12_3.
    /// </summary>
    [TestClass]
    public class MariaDB_12_3_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            var mdb = new MariaDB_12_3(false);
        ...
        {
            _searchForNewer(new MariaDB_12_3(false));
        }
        ...
        {
            _upToDate_info(new MariaDB_12_3(false));
        }
    }
}
