...
{
    /// <summary>
    /// Contains tests for MariaDB_10_11.
    /// </summary>
    [TestClass]
    public class MariaDB_10_11_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            var mdb = new MariaDB_10_11(false);
        ...
        {
            _searchForNewer(new MariaDB_10_11(false));
        }
        ...
        {
            _upToDate_info(new MariaDB_10_11(false));
        }
    }
}
