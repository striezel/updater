...
{
    /// <summary>
    /// Contains tests for OpenJDK8_32Bit class.
    /// </summary>
    [TestClass]
    public class OpenJDK8_32Bit_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            _info(new OpenJDK8_32Bit(false));
        }
        ...
        {
            var jdk = new OpenJDK8_32Bit(false);
        ...
        {
            _searchForNewer(new OpenJDK8_32Bit(false));
        }
        ...
        {
            _upToDate_info(new OpenJDK8_32Bit(false));
        }
        ...
        {
            var info = new OpenJDK8_32Bit(false).knownInfo();
