...
* Update certificate information for Eclipse Temurin JDK 8 LTS installer.
...
* Update certificate information for Eclipse Temurin JRE 17 LTS installer.
...
* Adjust search for newer versions of TeamSpeak Client.
* Adjust search for newer versions of Transmission.

__[maintenance]__

* NLog library is updated from 6.1.2 to 6.1.4.
* Update certificate information for Blender LTS installer.
...
* NLog library is updated from 6.0.7 to 6.1.1.
* Update certificate information for Blender LTS installer.
* Update certificate information for KeePass 2 installer.
* Update certificate information for Node.js installer.
...
* Adjust search for newer versions of HeidiSQL to not include nightly builds.
