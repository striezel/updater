...
{
    /// <summary>
    /// Contains tests for Opera class.
    /// </summary>
    [TestClass]
    public class Opera_Tests : BasicSoftwareTests
    {
        /// <summary>
        ...
        {
            _searchForNewer(new Opera(false));
        }
        ...
        {
            _upToDate_info(new Opera(false));
        }
